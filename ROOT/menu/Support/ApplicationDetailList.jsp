...
if(request.getParameter("SupportNo") == null) {
    ...
    if(utype.equals("business")){
        support.setOpencheck("yes");
        int so = dao.updateSupport(support);
    }
    ...
    <div class="main_wrap">
        ...
        <div class="board_write_wrap">
            <div class="board_write">
                <div class="title">
                        <dl>
                            <dt style="height : 50px;"><div class="Pstyle"><p class="Pstyle1">글 번호</p></div></dt>
                            <dd style="height : 50px;"><p class="Pstyle" style="margin:0 auto;width:95%"><%=support.getNo()%></p></dd>
                            <dt style="height : 50px;"><div class="Pstyle"><p class="Pstyle1">제목</p></div></dt>
                            <dd style="height : 50px;"><p style="margin:0 auto;width:95%"><%=support.getTitle()%></p></dd>
                        </dl>
                        <dl>
                            <dt style="height : 50px;"><div class="Pstyle"><p class="Pstyle1">보낸 사람</p></div></dt>
                            <dd style="height : 50px;"><p style="margin:0 auto;width:95%"><%=support.getSendid()%></p></dd>
                            <dt style="height : 50px;"><div class="Pstyle"><p class="Pstyle1">받은 사람</p></div></dt>
                            <dd style="height : 50px;"><p style="margin:0 auto;width:95%"><%=support.getReceiveid()%></p></dd>
                        </dl>
                        <dl>
                            <dt style="height : 50px;"><div class="Pstyle"><p class="Pstyle1">파일</p></div></dt>
                            <%
                            ...
                            %>
                            <dd style="height : 50px;"><p style="margin:0 auto;width:95%"><a style="color:blue" href="<%=request.getContextPath()%>/controller/filedownload.jsp?filename=<%=filename%>&fileroot=<%=fileroot%>&fileservername=<%=fileservername%>"><%=filename%></p></a></dd>
                            ...
                            <% } %>
                            <dt style="height : 50px;"><div class="Pstyle"><p class="Pstyle1">작성 날짜</p></div></dt>
                            <dd style="height : 50px;"><p style="margin:0 auto;width:95%"><%=support.getDate()%></p></dd><br>
                        </dl>
                        <dl>
                            <dt style="height : 50px;"><div class="Pstyle"><p class="Pstyle1">내용</p></div></dt>
                            <dd style="height : 50px;"><p style="margin:0 auto;width:95%"><%=support.getContent()%></p></dd><br>
                        </dl>
                        <div class="b_button">
