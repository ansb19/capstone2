...
if(request.getParameter("no") == null) {
    response.sendRedirect(request.getContextPath()+"/menu/Review/view.jsp");
} else {
...
<div id="wrap">
    <div class="board_wrap">
        ...
        <form action="<%=request.getContextPath()%>/menu/Review/boardModifyAction.jsp" method="post">
            <div class="board_write_wrap">
                <div class="board_write">
                    <div class="title">
                        <dl>
                            <dt>글 번호</dt>
                            <dd><input name="No" value="<%=reviewObject.getNo()%>" type="text" readonly="readonly"/></dd>
                            <dt>제목</dt>
                            <dd><input name="Title" value="<%=reviewObject.getTitle()%>" id="Title" type="text"/></dd>
                        </dl>
                        <dl>
                            <dt>기업</dt>
                            <dd><input name="Company" value="<%=reviewObject.getCompany()%>" id="Company" type="text"/></dd>
                            <dt>별점</dt>
                            <dd>
                                <fieldset class="rate">
                    ...
                    <div class="cont">
                        <textarea name="Content" id="Content" rows="5" cols="50"><%=reviewObject.getContent()%></textarea>
                    </div>
                </div>
                <div class="bt_wrap">
