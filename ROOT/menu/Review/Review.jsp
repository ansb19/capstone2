...
int totalRowCount = reviewDAO.selectTotalBoardCount();
int pagePerRow = 5; 
int beginRow = (currentPage-1)*pagePerRow;
List<ReviewObject> list = reviewDAO.selectBoardListPerPage(beginRow, pagePerRow);
%>
<!DOCTYPE html>
<html>
<head>
      ...
      <div id="board-list">
          <div class="container">
              <table class="board-table">
                  ...
                  <tbody>
                    <tbody>
                        <%
                                    for(ReviewObject b : list) {
                        %>
                                        <tr>
                                            <td><a href="<%=request.getContextPath()%>/menu/Review/boardView.jsp?no=<%=b.getNo()%>"><%=b.getNo()%></a></td>
                                            <td><a href="<%=request.getContextPath()%>/menu/Review/boardView.jsp?no=<%=b.getNo()%>"><%=b.getUser_id()%></a></td>
                                            <td><a href="<%=request.getContextPath()%>/menu/Review/boardView.jsp?no=<%=b.getNo()%>"><%=b.getTitle()%></a></td>
                                            <td><a href="<%=request.getContextPath()%>/menu/Review/boardView.jsp?no=<%=b.getNo()%>"><%=b.getCompany()%></a></td>
                                            <td><a href="<%=request.getContextPath()%>/menu/Review/boardView.jsp?no=<%=b.getNo()%>"><%=b.getRatings()%> / 10</a></td>
                                            <td><a href="<%=request.getContextPath()%>/menu/Review/boardView.jsp?no=<%=b.getNo()%>"><%=b.getDate()%></a></td>
                                        </tr>
                        <%        
                                    }
                        %>
          ...
          %>
              ...
              <% if(utype.equals("person")) {%>
                <button class="reviewbutton"><a style="color:white" href="<%=request.getContextPath()%>/menu/Review/boardAddForm.jsp">리뷰 작성</a></button>
                <% } %>
              </div>
