...
%>
    ...
    <div><%=board.getBoardUser()%></div>
    <div>
        <a href="<%=request.getContextPath()%>/boardModifyForm.jsp?boardNo=<%=board.getBoardNo()%>">수정</a>
        <a href="<%=request.getContextPath()%>/boardRemoveForm.jsp?boardNo=<%=board.getBoardNo()%>">삭제</a>
    </div>
<%
}
%>
